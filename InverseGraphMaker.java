...
public class InverseGraphMaker extends Application {

    @Override public void start(Stage stage) {

        stage.setTitle("Determinant vs. Trace On Inverse Matrix");
        ...
        sc.setTitle("Determinant vs. Trace On Inverse Matrix");
